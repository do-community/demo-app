...
def ddcloud_server(resource, module_name):
    ...
    attrs = {
        'id': raw_attrs['id'],
        'name': raw_attrs['name'],
        'primary_ip': raw_attrs['primary_adapter_ipv4'], # not available immediately after creation; you'll need to run terraform refresh first.
        'tags': tags,

        'network_domain': raw_attrs['networkdomain'],

        # ansible
        'ansible_ssh_host': raw_attrs['primary_adapter_ipv4'],
        'ansible_ssh_port': 22,
